...
| --- | ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- |
| 01  | [Calculator](01_Calculator/)                            | **Advanced CLI calculator** implemented in C++ using **classes, objects, and modular header files** (`.hpp`) for clean and reusable code.                          | ![Completed](https://img.shields.io/badge/completed-brightGreen?style=for-the-badge)   |
...
| 03  | [Student Manement System](03_Student_Management_System) | CLI-based system to manage student records using **OOP**, `std::vector`, and **File I/O** for persistent storage.                                                  | ![In Progress](https://img.shields.io/badge/completed-brightGreen?style=for-the-badge) |
